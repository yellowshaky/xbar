...
# <bitbar.title>KODEX Inverse Price</bitbar.title>
# <bitbar.version>v1.0</bitbar.version>
# <bitbar.author>User</bitbar.author>
# <bitbar.desc>KODEX Inverse ETF price monitor via Toss Invest</bitbar.desc>

CODE="A114800"
SYMBOL="114800.KS"
CACHE_FILE="/tmp/kodex_inverse_stock_cache.json"
CACHE_TTL=5
...
print("---")
print("↗ Toss   | href=https://www.tossinvest.com/stocks/A114800/order")
